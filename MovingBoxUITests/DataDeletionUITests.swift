...
final class DataDeletionUITests: XCTestCase {
    ...
    func testWarningSection() throws {
        ...
        XCTAssertTrue(
            dataDeletionScreen.inventoryItemsWarning.exists, "Inventory items warning should exist")
    ...
    func testScopeSelectionSection() throws {
        ...
        XCTAssertTrue(
            dataDeletionScreen.deletionScopeHeader.exists, "Deletion scope header should exist")
        XCTAssertTrue(dataDeletionScreen.localOnlyOption.exists, "Local only option should exist")
        XCTAssertTrue(
            dataDeletionScreen.localAndICloudOption.exists, "Local and iCloud option should exist")
        XCTAssertTrue(
            dataDeletionScreen.localOnlyDescription.exists, "Local only description should exist")
        XCTAssertTrue(
            dataDeletionScreen.localAndICloudDescription.exists,
            "Local and iCloud description should exist")
    }
    ...
    func testConfirmationSection() throws {
        ...
        XCTAssertTrue(
            dataDeletionScreen.isConfirmationSectionVisible(), "Confirmation section should be visible")

        // And: All confirmation elements should exist
        XCTAssertTrue(
            dataDeletionScreen.confirmationInstructions.exists, "Confirmation instructions should exist")
        XCTAssertTrue(
            dataDeletionScreen.confirmationTextField.exists, "Confirmation text field should exist")
        XCTAssertTrue(dataDeletionScreen.deleteButton.exists, "Delete button should exist")
        XCTAssertTrue(
            dataDeletionScreen.irreversibleWarning.exists, "Irreversible warning should exist")
    }
    ...
    func testScopeSelection() throws {
        ...
        XCTAssertTrue(
            dataDeletionScreen.localAndICloudOption.exists, "Local and iCloud option should still exist")
    }
    ...
    func testConfirmationValidation() throws {
        ...
        XCTAssertTrue(
            dataDeletionScreen.isDeleteButtonEnabled(),
            "Delete button should be enabled with correct text")

        // And: Confirmation text should be correct
        XCTAssertEqual(
            dataDeletionScreen.getConfirmationText(), "DELETE", "Confirmation text should be DELETE")
    }
    ...
    func testFinalConfirmationAlert() throws {
        ...
        XCTAssertTrue(
            dataDeletionScreen.isFinalConfirmationAlertVisible(), "Final confirmation alert should appear"
        )

        // And: Alert should have correct message
        let expectedMessage =
            "This action cannot be undone. Are you sure you want to delete all your inventory data?"
        XCTAssertEqual(
            dataDeletionScreen.getFinalConfirmationMessage(), expectedMessage,
            "Alert should have correct message")

        // And: Alert should have correct buttons
        XCTAssertTrue(
            dataDeletionScreen.areFinalConfirmationButtonsVisible(),
            "Alert should have Cancel and Delete buttons")
        ...
        XCTAssertFalse(
            dataDeletionScreen.isFinalConfirmationAlertVisible(), "Alert should disappear after cancel")
    }
    ...
    func testConfirmationTextEdgeCases() throws {
        ...
        for incorrectInput in incorrectInputs {
            ...
            XCTAssertTrue(
                dataDeletionScreen.deleteButton.exists,
                "Delete button should exist for input: '\(incorrectInput)'")
        }
