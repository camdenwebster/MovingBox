...
final class PhotoButtonVisibilityUITests: XCTestCase {
    ...
    func testProUserCanAddFirstPhoto() throws {
        ...
        XCTAssertTrue(
            detailScreen.waitForAddFirstPhotoButton(),
    ...
    func testProUserCanAddAdditionalPhotosFromCameral() throws {
        ...
        XCTAssertTrue(
            detailScreen.waitForAddAdditionalPhotoButton(),
        ...
        XCTAssertTrue(
            detailScreen.takePhotoButton.isHittable && detailScreen.chooseFromLibraryButton.isHittable
                && detailScreen.scanDocumentButton.isHittable,
            "The confirmation dialog should display the available photo options when tapped")
        ...
        XCTAssertEqual(
            detailScreen.photoCountText.label, "1 / 2",
            "The label displaying the number of photos should read 1/2")
    }
    ...
    func testFreeUserCannotAddSecondPhoto() throws {
        ...
        XCTAssertTrue(
            listScreen.allItemsNavigationTitle.waitForExistence(timeout: 5),
        ...
        // Wait for detail view to load and enter edit mode
        XCTAssertTrue(
            detailScreen.editButton.waitForExistence(timeout: 5),
        ...
        XCTAssertFalse(
            detailScreen.isAddAdditionalPhotoButtonVisible(),
