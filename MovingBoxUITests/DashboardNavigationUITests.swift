...
final class DashboardNavigationUITests: XCTestCase {
    ...
    func testDashboardDisplaysCorrectly() throws {
        ...
        XCTAssertTrue(dashboardScreen.allInventoryButton.exists, "All Inventory button should be visible")
        XCTAssertTrue(dashboardScreen.settingsButton.exists, "Settings button should be visible")
        XCTAssertTrue(dashboardScreen.addItemFromCameraButton.exists, "Add item camera button should be visible")
    }
    ...
    func testNavigationFromDashboardToAllItems() throws {
        ...
        XCTAssertTrue(dashboardScreen.allInventoryButton.waitForExistence(timeout: 10), 
        ...
        XCTAssertFalse(dashboardScreen.allInventoryButton.exists, 
    ...
    func testDashboardRecentItemsSection() throws {
        ...
        if dashboardScreen.hasRecentItems() {
            ...
            XCTAssertTrue(dashboardScreen.waitForRecentItems(), 
                         "Recent items should be visible")
            
            // And: View All Items button should be present
            XCTAssertTrue(dashboardScreen.viewAllItemsButton.waitForExistence(timeout: 5), 
                         "View All Items button should be visible when items exist")
        } else {
            // Then: Empty state should be shown
            XCTAssertTrue(dashboardScreen.isEmptyState(), 
                         "Empty state should be shown when no items exist")
            XCTAssertTrue(dashboardScreen.emptyStateAddItemButton.exists, 
    ...
    func testViewAllItemsButtonNavigation() throws {
        ...
        guard dashboardScreen.hasRecentItems() && 
              dashboardScreen.viewAllItemsButton.exists else {
    ...
    func testDashboardToolbarButtons() throws {
        ...
        XCTAssertTrue(dashboardScreen.settingsButton.exists, 
                     "Settings button should be in toolbar")
        XCTAssertTrue(dashboardScreen.addItemFromCameraButton.exists, 
    ...
    func testDashboardStatsLoadQuickly() throws {
        ...
        let startTime = Date()
        XCTAssertTrue(dashboardScreen.statCardValue.waitForExistence(timeout: 10), 
                     "Stats should load")
    ...
    func testDashboardAccessibilityIdentifiers() throws {
        ...
        XCTAssertTrue(dashboardScreen.allInventoryButton.exists, 
        ...
        XCTAssertTrue(dashboardScreen.statCardLabel.exists, 
                     "Stats card label should have accessibility identifier")
        XCTAssertTrue(dashboardScreen.statCardValue.exists, 
