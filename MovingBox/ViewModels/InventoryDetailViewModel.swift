...
final class InventoryDetailViewModel {
    ...
    func loadAllImages(for item: InventoryItem) async {
        ...
        if !item.secondaryPhotoURLs.isEmpty {
            do {
                let secondaryImages = try await imageManager.loadSecondaryImages(
        ...
        do {
            ...
            if item.imageURL == nil {
                ...
                guard let firstImage = images.first else {
                    throw NSError(
                        domain: "InventoryDetailViewModel", code: 1,
                ...
                if images.count > 1 {
                    ...
                    let secondaryURLs = try await imageManager.saveSecondaryImages(
            ...
            do {
                ...
                if let image = UIImage(data: data) {
                    ...
                    guard
                        ...
                        throw NSError(
                            domain: "InventoryDetailViewModel", code: 2,
