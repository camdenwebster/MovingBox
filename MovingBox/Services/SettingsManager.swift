...
class SettingsManager: ObservableObject {
    ...
    @Published var highQualityAnalysisEnabled: Bool {
        didSet {
            print(
                "📱 SettingsManager - highQualityAnalysisEnabled changed to: \(highQualityAnalysisEnabled)")
    ...
    init() {
        ...
        self.successfulAIAnalysisCount = UserDefaults.standard.integer(
            forKey: Keys.successfulAIAnalysisCount)
    ...
    private func setupInitialState() async {
        ...
        print(
            "📱 SettingsManager - Is-Pro argument present: \(ProcessInfo.processInfo.arguments.contains("Is-Pro"))"
        )
