...
final class InventoryItem: ObservableObject, PhotoManageable {
    ...
    init(
        title: String, quantityString: String, quantityInt: Int, desc: String, serial: String,
        model: String, make: String, location: InventoryLocation?, label: InventoryLabel?,
        price: Decimal, insured: Bool, assetId: String, notes: String, showInvalidQuantityAlert: Bool,
        hasUsedAI: Bool = false, secondaryPhotoURLs: [String] = [], purchaseDate: Date? = nil,
        warrantyExpirationDate: Date? = nil, purchaseLocation: String = "", condition: String = "",
        hasWarranty: Bool = false, depreciationRate: Double? = nil, replacementCost: Decimal? = nil,
        dimensionLength: String = "", dimensionWidth: String = "", dimensionHeight: String = "",
        dimensionUnit: String = "inches", weightValue: String = "", weightUnit: String = "lbs",
        color: String = "", storageRequirements: String = "", isFragile: Bool = false,
        movingPriority: Int = 3, roomDestination: String = ""
    ) {
        self.title = title
...
extension InventoryItem {
    ...
    final class Builder {
        ...
        @discardableResult
        func purchaseInfo(
            date: Date? = nil, location: String = "", hasWarranty: Bool = false,
        ...
        func physicalProperties(
            dimensionLength: String = "", dimensionWidth: String = "", dimensionHeight: String = "",
            dimensionUnit: String = "inches", weightValue: String = "", weightUnit: String = "lbs",
            color: String = "", storageRequirements: String = ""
        ) -> Builder {
        ...
        @discardableResult
        func movingInfo(isFragile: Bool = false, priority: Int = 3, roomDestination: String = "")
            -> Builder
        {
...
extension InventoryItem {
    ...
    func updateFromImageDetails(
        _ imageDetails: ImageDetails, labels: [InventoryLabel], locations: [InventoryLocation]
    ) {
        ...
        if let depreciationRateString = imageDetails.depreciationRate, !depreciationRateString.isEmpty {
            let cleanedString = depreciationRateString.replacingOccurrences(of: "%", with: "")
                .trimmingCharacters(in: .whitespaces)
