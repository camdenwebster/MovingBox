...
struct BatchItemCreationTests {
    ...
    func testBatchCreationPreservesOrder() async throws {
        ...
        let orderedItems = [
            DetectedInventoryItem(id: "first", title: "First Item", description: "", category: "Test", make: "", model: "", estimatedPrice: "", confidence: 0.9),
            DetectedInventoryItem(id: "second", title: "Second Item", description: "", category: "Test", make: "", model: "", estimatedPrice: "", confidence: 0.8),
            DetectedInventoryItem(id: "third", title: "Third Item", description: "", category: "Test", make: "", model: "", estimatedPrice: "", confidence: 0.7)
        ]
